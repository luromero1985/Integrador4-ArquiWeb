...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Administrador admin1 = new Administrador(null, 100.0f, 80.0f,  LocalDateTime.of(1850, 1, 1, 0, 0), 100);
        Administrador admin2 = new Administrador(null, 150.0f, 120.0f, LocalDateTime.of(2024, 6, 1, 0, 0), 500);
