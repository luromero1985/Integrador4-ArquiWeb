...
public class TokenProvider {
    ...
    //lo usamos cuando el usuario se autentica
    public String createToken( Authentication authentication ) {
        ...
        return Jwts
                ...
                .claim( AUTHORITIES_KEY, authorities ) //roles del usuario
                .signWith( key )
                .expiration(validity)
                .issuedAt( new Date() )// hora que creo el token
                .compact();
    }
    ...
    public boolean validateToken( String authToken ) {
        try {
            final var claims = Jwts.parser().verifyWith(this.key).build().parseSignedClaims(authToken); //chequa token, expiracion
